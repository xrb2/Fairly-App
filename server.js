...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://github.com/xrb2/Fairly-App.git'); // Update to your GitHub Pages URL (e.g., 'https://your-username.github.io') for production
